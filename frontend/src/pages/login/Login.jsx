                ...
                bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div>
                            ...
                            value={username} onChange={(e) => setUsername(e.target.value)} className="w-full input input-bordered h-10"/>
                        </div>
                        ...
                        <div>
                            ...
                            value={password} onChange={(e) => setPassword(e.target.value)} className="w-full input input-bordered h-10"/>
                        </div>
